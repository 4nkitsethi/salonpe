<template>
    ...
    <nav class="navbar navbar-expand-xl w-100 navbar-dark container gap-3">      
      <inertia-link class="nav-link" :href="route('salonpe.index')">  <img src="../assets/web/images/logo.png" class="logo-img" alt=""></inertia-link>
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
        <div class="offcanvas-header">
          <div class="offcanvas-logo"><img src="../assets/web/images/logo.webp" class="logo-img" alt="">
          </div>
          ...
          <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-large-menu">
                <div class="row">
                  ...
                  <!-- end col-3 -->
                  <div class="col-12 col-xl-4">
                    <h6 class="large-menu-title">Women</h6>
                    <ul class="list-unstyled">
                  ...
                  <div class="col-12 col-xl-4 d-none d-xl-block">
                    <div class="pramotion-banner1">
                      <img src="../assets/web/images/menu-img.webp" class="img-fluid" alt="" />
                    </div>
                  </div>
                  <!-- end col-3 -->
                </div>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><inertia-link class="dropdown-item" :href="route('salonpe.cart')">Cart</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.wishlist')">Wishlist</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.product.detail')">Product Detail</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.product.filter')">Product Filter</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.payment.method')">Payment Method</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.billing')">Billing Method</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.save.address')">Addresses</inertia-link></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.dashboard')">Dashboard</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.order')">My Orders</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.profile')">My Profile</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.profile.edit')">Edit Profile</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.save.address')">Addresses</inertia-link></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.login')">Login</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.register')">Register</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.account.change.password')">Password</inertia-link></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><inertia-link class="dropdown-item" :href="route('salonpe.blogs')">Blog Post</inertia-link></li>
                <li><inertia-link class="dropdown-item" :href="route('salonpe.blog.read')">Blog Read</inertia-link></li>
              </ul>
            </li>
          </ul>
        </div>
      ...
      <ul class="navbar-nav secondary-menu flex-row">
        ...
        <li class="nav-item">
          <inertia-link class="nav-link" :href="route('salonpe.wishlist')"><i class="bi bi-suit-heart"></i></inertia-link>
        </li>
        ...
        <li class="nav-item">
          <inertia-link class="nav-link" :href="route('salonpe.account.dashboard')"><i class="bi bi-person-circle"></i></inertia-link>
        </li>
      </ul>
    </nav>
  </header>
       ...
       <div class="row row-cols-1 row-cols-lg-4 g-4">
        <div class="col">
          <div class="footer-widget-6">
            <img src="../assets/web/images/logo.png" class="logo-img mb-3" alt="">
       ...
       <div class="row">
         <div class="col-12">
          ...
          <div class="app-icon d-flex flex-column flex-sm-row align-items-center justify-content-center gap-2">
            <div>
              <a href="javascript:;">
                <img src="../assets/web/images/play-store.webp" width="160" alt="">
              </a>
            </div>
            <div>
              <a href="javascript:;">
                <img src="../assets/web/images/apple-store.webp" width="160" alt="">
              </a>
            </div>
          </div>
         </div>
    ...
    <div class="offcanvas-body">
      <div class="cart-list">
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/01.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/02.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/03.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/04.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/05.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/06.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/07.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/08.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/09.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="bottom-product-img">
            <a href="product-details.html">
              <img src="../assets/web/images/new-arrival/10.webp" width="60" alt="">
            </a>
          </div>
          <div class="">
            <h6 class="mb-0 fw-light mb-1">Product Name</h6>
            ...
            <div class="col-12 col-xl-6">
              ...
              <div class="wrap-modal-slider">
                ...
                <div class="slider-for">
                  <div>
                    <img src="../assets/web/images/product-images/01.jpg" alt="" class="img-fluid">
                  </div>
                  <div>
                    <img src="../assets/web/images/product-images/02.jpg" alt="" class="img-fluid">
                  </div>
                  <div>
                    <img src="../assets/web/images/product-images/03.jpg" alt="" class="img-fluid">
                  </div>
                  <div>
                    <img src="../assets/web/images/product-images/04.jpg" alt="" class="img-fluid">
                  </div>
                </div>
