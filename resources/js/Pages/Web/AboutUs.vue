        ...
        <section class="section-padding">
            ...
            <div class="row row-cols-1 row-cols-xl-3 g-4 why-choose">
                ...
                <div class="card rounded-0 shadow-none w-100">
                    <div class="card-body">
                    <img src="../../assets/web/images/icons/delivery.webp" width="60" alt="">
                ...
                <div class="card rounded-0 shadow-none w-100">
                    <div class="card-body">
                    <img src="../../assets/web/images/icons/money-bag.webp" width="60" alt="">
                ...
                <div class="card rounded-0 shadow-none w-100">
                    <div class="card-body">
                    <img src="../../assets/web/images/icons/support.webp" width="60" alt="">
