              ...
              <form>
                ...
                <div class="blog-categories recent-post mb-4">
                  ...
                  <div class="d-flex align-items-start">
                    <img src="../../assets/web/images/blog/01.webp" width="100" alt="">
                  ...
                  <div class="d-flex align-items-start">
                    <img src="../../assets/web/images/blog/02.webp" width="100" alt="">
                    <div class="ms-3"> <a href="javascript:;" class="fs-6 fw-bold text-content">Post title here</a>
                      <p class="mb-0">March 15, 2021</p>
                    </div>
                  </div>
                  <div class="my-3 border-bottom"></div>
                  <div class="d-flex align-items-start">
                    <img src="../../assets/web/images/blog/03.webp" width="100" alt="">
                    <div class="ms-3"> <a href="javascript:;" class="fs-6 fw-bold text-content">Post title here</a>
                      <p class="mb-0">March 15, 2021</p>
                    </div>
                  </div>
