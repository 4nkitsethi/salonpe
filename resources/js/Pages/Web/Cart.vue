    ...
    <div class="container">
			  ...
			  <div class="card-body">
			    <div class="d-flex flex-column flex-lg-row gap-3">
				   <div class="product-img">
				      <img src="../../assets/web/images/featured-products/01.webp" width="150" alt="">
				   </div>
      ...
      <div class="card rounded-0 mb-3">
			  <div class="card-body">
			    <div class="d-flex flex-column flex-lg-row gap-3">
				   <div class="product-img">
				      <img src="../../assets/web/images/featured-products/02.webp" width="150" alt="">
				   </div>
				    <div class="product-info flex-grow-1">
				      <h5 class="fw-bold mb-0">AKS - Checked Straight Kurta</h5>
					    <div class="product-price d-flex align-items-center gap-2 mt-3">
      ...
      <div class="card rounded-0 mb-3">
			  <div class="card-body">
			    <div class="d-flex flex-column flex-lg-row gap-3">
				   <div class="product-img">
				      <img src="../../assets/web/images/featured-products/03.webp" width="150" alt="">
				   </div>
				    <div class="product-info flex-grow-1">
				      <h5 class="fw-bold mb-0">AKS - Checked Straight Kurta</h5>
					    <div class="product-price d-flex align-items-center gap-2 mt-3">
      ...
      <div class="card rounded-0 mb-3">
			  <div class="card-body">
			    <div class="d-flex flex-column flex-lg-row gap-3">
				   <div class="product-img">
				      <img src="../../assets/web/images/featured-products/07.webp" width="150" alt="">
				   </div>
				    <div class="product-info flex-grow-1">
				      <h5 class="fw-bold mb-0">AKS - Checked Straight Kurta</h5>
					    <div class="product-price d-flex align-items-center gap-2 mt-3">
      ...
      <div class="card rounded-0 mb-0">
			  <div class="card-body">
			    <div class="d-flex flex-column flex-lg-row gap-3">
				   <div class="product-img">
				      <img src="../../assets/web/images/featured-products/05.webp" width="150" alt="">
				   </div>
				    <div class="product-info flex-grow-1">
				      <h5 class="fw-bold mb-0">AKS - Checked Straight Kurta</h5>
					    <div class="product-price d-flex align-items-center gap-2 mt-3">
