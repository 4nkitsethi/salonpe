                ...
                <div class="col-12 col-xl-5">
                    <div class="product-info">
                        ...
                        <div class="more-colors mt-4">
                            ...
                            <div class="">
                                <a href="javascript:;">
                                <img src="../../assets/web/images/featured-products/01.webp" width="65" alt="">
                                </a>
                            </div>
                            <div class="">
                                <a href="javascript:;">
                                <img src="../../assets/web/images/featured-products/02.webp" width="65" alt="">
                                </a>
                            </div>
                            <div class="">
                                <a href="javascript:;">
                                <img src="../../assets/web/images/featured-products/03.webp" width="65" alt="">
                                </a>
                            </div>
                            <div class="">
                                <a href="javascript:;">
                                <img src="../../assets/web/images/featured-products/04.webp" width="65" alt="">
                                </a>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="customer-reviews">
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-3">
                                ...
                                <div class="review-img">
                                    <img src="../../assets/web/images/featured-products/05.webp" alt="" width="70">
                                </div>
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-3">
                                ...
                                <div class="review-img">
                                    <img src="../../assets/web/images/featured-products/02.webp" alt="" width="70">
                                </div>
                                <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                                    <div class="hstack flex-grow-1 gap-3">
                                    <p class="mb-0">Jhon Deo</p>
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-3">
                                ...
                                <div class="review-img">
                                    <img src="../../assets/web/images/featured-products/04.webp" alt="" width="70">
                                </div>
                                <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                                    <div class="hstack flex-grow-1 gap-3">
                                    <p class="mb-0">Jhon Deo</p>
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-3">
                                ...
                                <div class="review-img">
                                    <img src="../../assets/web/images/featured-products/01.webp" alt="" width="70">
                                </div>
                                <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                                    <div class="hstack flex-grow-1 gap-3">
                                    <p class="mb-0">Jhon Deo</p>
        ...
        <section class="section-padding">
            ...
            <div class="similar-products">
                ...
                <div class="col">
                    ...
                    <img src="../../assets/web/images/best-sellar/03.webp" alt="" class="card-img-top rounded-0">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/new-arrival/02.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/best-sellar/02.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/new-arrival/04.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/new-arrival/05.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/trending-product/03.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/featured-products/05.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/trending-product/05.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/trending-product/01.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
                ...
                <div class="col">
                    <a href="javascript:;">
                    <div class="card rounded-0">
                    <img src="../../assets/web/images/trending-product/02.webp" alt="" class="card-img-top rounded-0">
                    <div class="card-body border-top">
                        <h5 class="mb-0 fw-bold product-short-title">Syndrona</h5>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-3 mt-2">
