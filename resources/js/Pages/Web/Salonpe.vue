    ...
    <WebLayout>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active bg-primary">
                ...
                <div class="col">
                    <img src="../../assets/web/images/sliders/s_1.webp" class="img-fluid" alt="...">
                </div>
                </div>
            </div>
            <div class="carousel-item bg-red">
                ...
                <div class="col">
                    <img src="../../assets/web/images/sliders/s_2.webp" class="img-fluid" alt="...">
                </div>
                </div>
            </div>
            <div class="carousel-item bg-purple">
                ...
                <div class="col">
                    <img src="../../assets/web/images/sliders/s_3.webp" class="img-fluid" alt="...">
                </div>
                </div>
            </div>
            <div class="carousel-item bg-yellow">
                ...
                <div class="col">
                    <img src="../../assets/web/images/sliders/s_4.webp" class="img-fluid" alt="...">
                </div>
                </div>
            </div>
            <div class="carousel-item bg-green">
                ...
                <div class="col">
                    <img src="../../assets/web/images/sliders/s_5.webp" class="img-fluid" alt="...">
                </div>
                </div>
            </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/01.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/02.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/03.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/04.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/05.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/06.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/07.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="card">
                ...
                <a href="product-details.html">
                    <img src="../../assets/web/images/featured-products/08.webp" class="card-img-top" alt="...">
                </a>
                </div>
                <div class="card-body">
                <div class="product-info text-center">
            ...
            <div class="tab-pane fade show active" id="new-arrival">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/01.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/02.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/03.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/04.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/05.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/06.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/07.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/08.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/09.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/new-arrival/10.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
            ...
            <div class="tab-pane fade" id="best-sellar">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/best-sellar/01.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/best-sellar/02.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/best-sellar/03.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/best-sellar/04.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/best-sellar/05.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
            ...
            <div class="tab-pane fade" id="trending-product">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/trending-product/01.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/trending-product/02.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="javascript:;">
                        <img src="../../assets/web/images/trending-product/03.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/trending-product/04.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/trending-product/05.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
            ...
            <div class="tab-pane fade" id="special-offer">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/special-offer/01.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/special-offer/02.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/special-offer/03.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/special-offer/04.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
                ...
                <div class="col">
                    ...
                    <div class="position-relative overflow-hidden">
                        ...
                        <a href="product-details.html">
                        <img src="../../assets/web/images/special-offer/05.webp" class="card-img-top" alt="...">
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="product-info text-center">
        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <img src="../../assets/web/images/extra-images/promo-large.webp" class="img-fluid rounded-0" alt="...">
                </div>
                <div class="col-lg-6">
                <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-lg-5 g-4">
                ...
                <div class="p-3 border rounded brand-box">
                    ...
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/01.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/02.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/03.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/04.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/05.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/06.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/07.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/08.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/09.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
                ...
                <div class="p-3 border rounded brand-box">
                    <div class="d-flex align-items-center">
                    <a href="javascript:;">
                        <img src="../../assets/web/images/brands/10.webp" class="img-fluid" alt="">
                    </a>
                    </div>
                </div>
                </div>
        ...
        <div class="container">
            ...
            <a href="shop-grid-type-4.html">
                ...
                <div class="card-body">
                    ...
                    <img src="../../assets/web/images/categories/01.webp" class="card-img-top rounded-0" alt="...">
                    </div>
            ...
            <a href="shop-grid-type-4.html">
                ...
                <div class="card-body">
                    <div class="overflow-hidden">
                    <img src="../../assets/web/images/categories/02.webp" class="card-img-top rounded-0" alt="...">
                    </div>
                    <div class="text-center">
            ...
            <a href="shop-grid-type-4.html">
                ...
                <div class="card-body">
                    <div class="overflow-hidden">
                    <img src="../../assets/web/images/categories/03.webp" class="card-img-top rounded-0" alt="...">
                    </div>
                    <div class="text-center">
            ...
            <a href="shop-grid-type-4.html">
                ...
                <div class="card-body">
                    <div class="overflow-hidden">
                    <img src="../../assets/web/images/categories/04.webp" class="card-img-top rounded-0" alt="...">
                    </div>
                    <div class="text-center">
            ...
            <a href="shop-grid-type-4.html">
                ...
                <div class="card-body">
                    <div class="overflow-hidden">
                    <img src="../../assets/web/images/categories/05.webp" class="card-img-top rounded-0" alt="...">
                    </div>
                    <div class="text-center">
            ...
            <a href="shop-grid-type-4.html">
                ...
                <div class="card-body">
                    <div class="overflow-hidden">
                    <img src="../../assets/web/images/categories/06.webp" class="card-img-top rounded-0" alt="...">
                    </div>
                    <div class="text-center">
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-lg-3 g-4">
                <div class="col">
                <div class="card">
                    <img src="../../assets/web/images/blog/01.webp" class="card-img-top rounded-0" alt="...">
                    <div class="card-body">
                ...
                <div class="col">
                <div class="card">
                    <img src="../../assets/web/images/blog/02.webp" class="card-img-top rounded-0" alt="...">
                    <div class="card-body">
                    <div class="d-flex align-items-center gap-4">
                        <div class="posted-by">
                        <p class="mb-0"><i class="bi bi-person me-2"></i>Virendra</p>
                ...
                <div class="col">
                <div class="card">
                    <img src="../../assets/web/images/blog/03.webp" class="card-img-top rounded-0" alt="...">
                    <div class="card-body">
                    <div class="d-flex align-items-center gap-4">
                        <div class="posted-by">
                        <p class="mb-0"><i class="bi bi-person me-2"></i>Virendra</p>
